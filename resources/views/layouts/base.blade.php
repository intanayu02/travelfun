                                    ...
                                    <li class="onhover-dropdown">
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                @if(Route::has('login'))
                                                @auth
                                                  @if(Auth::user()->urtype =='ADM')
                                                  <li>
                                                    <a href="{{route('admin.index')}}" class="d-block">Dasboard</a>
                                                 </li>
                                                  @else
                                                  <li>
                                                    <a href="{{route('user.index')}}" class="d-block">Mu Account</a>
                                                 </li>
                                                  @endif
                                                  <li>
                                                    <a href="{{route('logout')}}" onclick="event.preventDefaul();document.getElementById('frmlogout').submit();" class="d-block">logout</a>
                                                    <from id="frmlogout" action="{{route('logout')}}">
                                                        @csrf
                                                    </from>
                                                  </li>
                                                  @else
